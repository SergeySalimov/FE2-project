export const CONFIG = {
  ...
  elements: {
    ...
    messagesPage: document.getElementById('messages'),
    ...
    navBtnLogOut: document.querySelector('.btn-nav-log-out'),
    ...
    nav2HomeOak: document.querySelector('.home-page-btn'),
    ...
    nameInHeader: document.querySelector('.cabinet'),
